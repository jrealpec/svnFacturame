	...
	return this.each( function() {
		...
		*/
		...
		this.createTableForGroup = function(group, parentgroup) {
			...
			var inputAddRule = $("<input type='button' value='+' title='Agregar regla' class='add-rule ui-add'/>"), cm;
		...
		this.createTableRowForRule = function(rule, group ) {
			...
			// create button for: Eliminar regla
			if(this.p.ruleButtons === true) {
			var ruleDeleteInput = $("<input type='button' value='-' title='Eliminar regla' class='delete-rule ui-del'/>");
